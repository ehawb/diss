...
"""A summary of the planes in the K3 encoder:
    0 --> black edges
    1 --> red edges
    2 --> blue edges
    3 --> red K3
...
class K3Encoder(Encoder):
    def __init__(self, graph_order):
        ...
        self.num_planes =5
        self.red_dict = {2: 1, 3: 3}
        self.blue_dict = {2: 2, 3: 4}
    ...
    def symmetric_encoding(self, game_state, shifted = None):
        ...
        k3_tensor = np.concatenate([board_tensor[6:], board_tensor[5:6]])
        symmetric_board_tensor = np.concatenate([black_tensor, player_tensor, k2_tensor, k3_tensor])
