...
"""
A K5 encoder designed for more general use, so being used on graphs of different
orders.
...
class K5TriColorEncoder(Encoder):
    def __init__(self, host_graph_order):
        self.size = host_graph_order
        self.num_planes = 13
        self.player_dict = {'red': 1, 'blue': 2, 'green': 3}
        self.red_dict = {2: 4, 3: 7, 4: 10, 5: 13}
        self.blue_dict = {2: 5, 3: 8, 4: 11, 5: 14}
        self.green_dict = {2: 6, 3: 9, 4: 12, 5: 15}
        self.main_dict = {'black': 0,
                          ...
                          'red_k5': 13, 'blue_k5': 14, 'green_k5': 15
                          }
    ...
    def symmetric_encoding(self, game_state, shifted = None):
        ...
        player_red, player_blue, player_green = board_tensor[1:2], board_tensor[2:3], board_tensor[3:4]
        player_tensor = np.concatenate('arrays')
        k2_red, k2_blue, k2_green = board_tensor[4:5], board_tensor[5:6], board_tensor[6:7]
        k2_tensor = np.concatenate('arrays')
        k3_red, k3_blue, k3_green = board_tensor[7:8], board_tensor[8:9], board_tensor[9:10]
        k3_tensor = np.concatenate('arrays')
        k4_red, k4_blue, k4_green = board_tensor[10:11], board_tensor[11:12],board_tensor[12:13]
